          ...
          <div className="bg-brand-wine text-white p-8 sm:p-12 border-b-4" style={{ borderBottomColor: 'var(--color-brand-gold, #dfb750)' }}>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-5">
                <div className="p-2.5 bg-[#5c0f22] border border-brand-gold/40 rounded-2xl shrink-0 flex items-center justify-center shadow-inner print:shadow-none">
                  <img 
                    src="/logo.svg" 
                    alt="Dons Leather Atelier logo"
                    className="atelier-logo-preview rounded-lg object-contain"
